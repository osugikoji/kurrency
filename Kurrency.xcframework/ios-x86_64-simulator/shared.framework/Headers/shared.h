...
@class SharedKurrencySetup, SharedKoin_coreKoinApplication, SharedKurrencySetupBuilder, SharedAppDatabaseCompanion, SharedGetCurrencyRate, SharedRuntimeQuery<__covariant RowType>, SharedExchangeRate, SharedCurrencyRate, SharedExchangeRateEntity, SharedRateDto, SharedApiResult<T>, SharedRateDtoCompanion, SharedKotlinThrowable, SharedKotlinEnumCompanion, SharedKotlinEnum<E>, SharedCurrencyCodeCompanion, SharedCurrencyCode, SharedKotlinArray<T>, SharedCurrentCurrencyUseCaseCompanion, SharedRateUseCaseCompanion, SharedKoin_coreScope, SharedKoin_coreParametersHolder, SharedKotlinLazyThreadSafetyMode, SharedKoin_coreModule, SharedKoin_coreLogger, SharedKoin_coreInstanceRegistry, SharedKoin_corePropertyRegistry, SharedKoin_coreScopeRegistry, SharedKoin_coreKoin, SharedCurrentCurrencyUseCase, SharedRateUseCase, SharedKoin_coreKoinApplicationCompanion, SharedKoin_coreLevel, SharedRuntimeTransacterTransaction, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKoin_coreLockable, SharedKoin_coreParametersHolderCompanion, SharedKoin_coreInstanceFactory<T>, SharedKotlinPair<__covariant A, __covariant B>, SharedKoin_coreScopeDSL, SharedKoin_coreSingleInstanceFactory<T>, SharedKoin_coreScopeRegistryCompanion, SharedKotlinByteArray, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing, SharedKoin_coreBeanDefinition<T>, SharedKoin_coreInstanceFactoryCompanion, SharedKoin_coreInstanceContext, SharedKotlinByteIterator, SharedKoin_coreKind, SharedKoin_coreCallbacks<T>;

@protocol SharedCacheManager, SharedAppDatabaseQueries, SharedRuntimeTransactionWithoutReturn, SharedRuntimeTransactionWithReturn, SharedRuntimeTransacter, SharedAppDatabase, SharedRuntimeSqlDriver, SharedRuntimeSqlDriverSchema, SharedKotlinx_serialization_coreKSerializer, SharedKotlinComparable, SharedCurrencyApi, SharedExchangeRateDao, SharedKoin_coreKoinScopeComponent, SharedKoin_coreQualifier, SharedKotlinKClass, SharedKotlinLazy, SharedRuntimeTransactionCallbacks, SharedRuntimeSqlPreparedStatement, SharedRuntimeSqlCursor, SharedRuntimeCloseable, SharedRuntimeQueryListener, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKotlinIterator, SharedKoin_coreScopeCallback, SharedKoin_coreKoinComponent, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_coreCompositeDecoder, SharedKotlinx_serialization_coreSerializersModuleCollector;
...
__attribute__((swift_name("KurrencySetup")))
@interface SharedKurrencySetup : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)kurrencySetup __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedKurrencySetup *shared __attribute__((swift_name("shared")));
- (SharedKoin_coreKoinApplication *)getKoinApp __attribute__((swift_name("getKoinApp()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KurrencySetup.Builder")))
@interface SharedKurrencySetupBuilder : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (SharedKurrencySetupBuilder *)setCacheManagerCacheManager:(id<SharedCacheManager>)cacheManager __attribute__((swift_name("setCacheManager(cacheManager:)")));
...
@required
- (SharedRuntimeQuery<SharedGetCurrencyRate *> *)getCurrencyRate __attribute__((swift_name("getCurrencyRate()")));
- (SharedRuntimeQuery<id> *)getCurrencyRateMapper:(id (^)(NSString *, NSString *, NSString *, SharedDouble * _Nullable))mapper __attribute__((swift_name("getCurrencyRate(mapper:)")));
- (void)insertOrReplaceExchangeRate:(SharedExchangeRate *)ExchangeRate __attribute__((swift_name("insertOrReplace(ExchangeRate:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CurrencyRate")))
@interface SharedCurrencyRate : SharedBase
- (instancetype)initWithBaseCurrency:(NSString *)baseCurrency currency:(NSString *)currency value_:(SharedDouble * _Nullable)value_ __attribute__((swift_name("init(baseCurrency:currency:value_:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString *)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedDouble * _Nullable)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedCurrencyRate *)doCopyBaseCurrency:(NSString *)baseCurrency currency:(NSString *)currency value_:(SharedDouble * _Nullable)value_ __attribute__((swift_name("doCopy(baseCurrency:currency:value_:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ExchangeRate")))
@interface SharedExchangeRate : SharedBase
- (instancetype)initWithBaseCurrency:(NSString *)baseCurrency __attribute__((swift_name("init(baseCurrency:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedExchangeRate *)doCopyBaseCurrency:(NSString *)baseCurrency __attribute__((swift_name("doCopy(baseCurrency:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *baseCurrency __attribute__((swift_name("baseCurrency")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetCurrencyRate")))
@interface SharedGetCurrencyRate : SharedBase
- (instancetype)initWithBaseCurrency:(NSString *)baseCurrency baseCurrency_:(NSString *)baseCurrency_ currency:(NSString *)currency value_:(SharedDouble * _Nullable)value_ __attribute__((swift_name("init(baseCurrency:baseCurrency_:currency:value_:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (NSString *)component2 __attribute__((swift_name("component2()"))) __attribute__((deprecated("use corresponding property instead")));
...
- (SharedGetCurrencyRate *)doCopyBaseCurrency:(NSString *)baseCurrency baseCurrency_:(NSString *)baseCurrency_ currency:(NSString *)currency value_:(SharedDouble * _Nullable)value_ __attribute__((swift_name("doCopy(baseCurrency:baseCurrency_:currency:value_:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *baseCurrency __attribute__((swift_name("baseCurrency")));
@property (readonly) NSString *baseCurrency_ __attribute__((swift_name("baseCurrency_")));
@property (readonly) NSString *currency __attribute__((swift_name("currency")));
@property (readonly) SharedDouble * _Nullable value_ __attribute__((swift_name("value_")));
@end

__attribute__((swift_name("ExchangeRateDao")))
@protocol SharedExchangeRateDao
@required
- (SharedExchangeRateEntity *)createExchangeRateEntity:(SharedExchangeRateEntity *)exchangeRateEntity __attribute__((swift_name("create(exchangeRateEntity:)")));
- (SharedExchangeRateEntity *)getBaseCurrency:(NSString *)baseCurrency __attribute__((swift_name("get(baseCurrency:)")));
- (SharedExchangeRateEntity *)updateExchangeRateEntity:(SharedExchangeRateEntity *)exchangeRateEntity __attribute__((swift_name("update(exchangeRateEntity:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ExchangeRateEntity")))
@interface SharedExchangeRateEntity : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property NSString *baseCurrency __attribute__((swift_name("baseCurrency")));
@property NSDictionary<NSString *, SharedDouble *> *rates __attribute__((swift_name("rates")));
@end

__attribute__((swift_name("CacheManager")))
@protocol SharedCacheManager
@required
...
__attribute__((swift_name("CurrencyApi")))
@protocol SharedCurrencyApi
@required
...
*/
- (void)getRateBaseCurrency:(NSString *)baseCurrency currencies:(NSArray<NSString *> *)currencies completionHandler:(void (^)(SharedApiResult<SharedRateDto *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getRate(baseCurrency:currencies:completionHandler:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RateDto")))
@interface SharedRateDto : SharedBase
- (instancetype)initWithData:(NSDictionary<NSString *, SharedDouble *> *)data __attribute__((swift_name("init(data:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedRateDtoCompanion *companion __attribute__((swift_name("companion")));
- (NSDictionary<NSString *, SharedDouble *> *)component1 __attribute__((swift_name("component1()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedRateDto *)doCopyData:(NSDictionary<NSString *, SharedDouble *> *)data __attribute__((swift_name("doCopy(data:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSDictionary<NSString *, SharedDouble *> *data __attribute__((swift_name("data")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RateDto.Companion")))
@interface SharedRateDtoCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedRateDtoCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ApiResult")))
@interface SharedApiResult<T> : SharedBase
- (instancetype)initWithBody:(T _Nullable)body code:(SharedInt * _Nullable)code headers:(NSDictionary<NSString *, NSArray<NSString *> *> *)headers throwable:(SharedKotlinThrowable * _Nullable)throwable __attribute__((swift_name("init(body:code:headers:throwable:)"))) __attribute__((objc_designated_initializer));
...
- (NSDictionary<NSString *, NSArray<NSString *> *> *)component3 __attribute__((swift_name("component3()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedKotlinThrowable * _Nullable)component4 __attribute__((swift_name("component4()"))) __attribute__((deprecated("use corresponding property instead")));
- (SharedApiResult<T> *)doCopyBody:(T _Nullable)body code:(SharedInt * _Nullable)code headers:(NSDictionary<NSString *, NSArray<NSString *> *> *)headers throwable:(SharedKotlinThrowable * _Nullable)throwable __attribute__((swift_name("doCopy(body:code:headers:throwable:)")));
- (void)ensureSuccess __attribute__((swift_name("ensureSuccess()")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (T _Nullable)getBodyOrThrow __attribute__((swift_name("getBodyOrThrow()")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface SharedCurrencyCode : SharedKotlinEnum<SharedCurrencyCode *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) SharedCurrencyCodeCompanion *companion __attribute__((swift_name("companion")));
@property (class, readonly) SharedCurrencyCode *brl __attribute__((swift_name("brl")));
@property (class, readonly) SharedCurrencyCode *cad __attribute__((swift_name("cad")));
@property (class, readonly) SharedCurrencyCode *cny __attribute__((swift_name("cny")));
@property (class, readonly) SharedCurrencyCode *eur __attribute__((swift_name("eur")));
@property (class, readonly) SharedCurrencyCode *jpy __attribute__((swift_name("jpy")));
@property (class, readonly) SharedCurrencyCode *krw __attribute__((swift_name("krw")));
@property (class, readonly) SharedCurrencyCode *usd __attribute__((swift_name("usd")));
@property (class, readonly) SharedCurrencyCode *none __attribute__((swift_name("none")));
+ (SharedKotlinArray<SharedCurrencyCode *> *)values __attribute__((swift_name("values()")));
@property (readonly) NSString *description_ __attribute__((swift_name("description_")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CurrencyCode.Companion")))
@interface SharedCurrencyCodeCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCurrencyCodeCompanion *shared __attribute__((swift_name("shared")));
- (NSArray<SharedCurrencyCode *> *)allCurrencies __attribute__((swift_name("allCurrencies()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CurrentCurrencyUseCase")))
@interface SharedCurrentCurrencyUseCase : SharedBase
- (instancetype)initWithCacheManager:(id<SharedCacheManager>)cacheManager __attribute__((swift_name("init(cacheManager:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedCurrentCurrencyUseCaseCompanion *companion __attribute__((swift_name("companion")));
- (SharedCurrencyCode *)getFromCurrency __attribute__((swift_name("getFromCurrency()")));
- (SharedCurrencyCode *)getToCurrency __attribute__((swift_name("getToCurrency()")));
- (void)saveFromCurrencyCurrencyCode:(SharedCurrencyCode *)currencyCode __attribute__((swift_name("saveFromCurrency(currencyCode:)")));
- (void)saveToCurrencyCurrencyCode:(SharedCurrencyCode *)currencyCode __attribute__((swift_name("saveToCurrency(currencyCode:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CurrentCurrencyUseCase.Companion")))
@interface SharedCurrentCurrencyUseCaseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedCurrentCurrencyUseCaseCompanion *shared __attribute__((swift_name("shared")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RateUseCase")))
@interface SharedRateUseCase : SharedBase
- (instancetype)initWithCurrencyApi:(id<SharedCurrencyApi>)currencyApi exchangeRateDao:(id<SharedExchangeRateDao>)exchangeRateDao cacheManager:(id<SharedCacheManager>)cacheManager __attribute__((swift_name("init(currencyApi:exchangeRateDao:cacheManager:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedRateUseCaseCompanion *companion __attribute__((swift_name("companion")));
- (double)convertValueBaseCurrency:(SharedCurrencyCode *)baseCurrency toCurrency:(SharedCurrencyCode *)toCurrency value:(double)value __attribute__((swift_name("convertValue(baseCurrency:toCurrency:value:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)fetchRatesWithCompletionHandler:(void (^)(SharedBoolean * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("fetchRates(completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)fetchRatesIfNeededWithCompletionHandler:(void (^)(SharedBoolean * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("fetchRatesIfNeeded(completionHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RateUseCase.Companion")))
@interface SharedRateUseCaseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedRateUseCaseCompanion *shared __attribute__((swift_name("shared")));
@end
...
@property (readonly) id<SharedCacheManager> cacheManager __attribute__((swift_name("cacheManager")));
@property (readonly) SharedCurrentCurrencyUseCase *currentCurrencyUseCase __attribute__((swift_name("currentCurrencyUseCase")));
@property (readonly) SharedRateUseCase *rateUseCase __attribute__((swift_name("rateUseCase")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PlatformDataModuleKt")))
@interface SharedPlatformDataModuleKt : SharedBase
+ (SharedKoin_coreModule *)platformDataModule __attribute__((swift_name("platformDataModule()")));
@end
